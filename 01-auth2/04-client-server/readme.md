...
curl -X POST "http://localhost:8080/oauth/token" --user clientdevops:112233 -d
...
详见[04-client-server.postman_collection.json](src/main/resources/04-client-server.postman_collection.json)